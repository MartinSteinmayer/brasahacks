...
async function submitUserMessage(content: string) {
  ...
  const result = await streamUI({
    ...
    Você é o Stênio, um assistente de negócios da empresa Stone, feito para auxiliar a vida de empreendedores pequenos lojistas
        ...
        Se ele pedir recomendações, faça 2 recomendações fora da caixa e práticas com base nisso para o segmento mais frequente e indique que irá montar um dashboard personalizado
        para ele visualizar alguma métrica.
